...
export default function  Userbookinghall (props) {
      ...
      React.useEffect(() => {
         ...
         axios({
            method :'post',
            url : 'http://localhost:9000/userget/seminarhall/booking/userbookings',
    ...
    const handeldelete=(book_,room_)=>{
          if(window.confirm('Are you sure you want to delete')){
              ...
              axios({
                  method:'POST',
                  url:'http://localhost:9000/userget/seminarhall/bookings_delete',
    ...
    const handleupdate=(event)=>{
        ...
        axios({
            method :'post',
            url : 'http://localhost:9000/userget/hall/booking_update',
            headers :{'content-type':'application/json'},
            data: obj
        }).then(response=>{
                            ...
                            {c_bookings.map((item)=>{
                                ...
                                return <div class="booked-slot-list-slots">
                                            ...
                                            <div class="admin-create">
                                               <span class="admin-button sub-admin-create" onClick={()=>handeldelete(item._id,room)}>delete</span>
