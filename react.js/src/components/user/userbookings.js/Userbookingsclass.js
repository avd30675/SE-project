...
export default function  Userbookingsclass (props) {
      ...
      React.useEffect(() => {
         ...
         axios({
            method :'post',
            url : 'http://localhost:9000/userget/classroom/booking/userbookings',
    ...
    const handeldelete=(book_,room_)=>{
          if(window.confirm('Are you sure you want to delete')){
              ...
              axios({
                  method:'POST',
                  url:'http://localhost:9000/userget/classroom/bookings_delete',
