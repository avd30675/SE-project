...
export default function  Singlehall (props) {
    ...
    axios({
            method :'GET',
            url : 'http://localhost:9000/userget/seminarhall/'+r_id,
            headers :{'Content-Type':'application/json'}
        }).then(response =>{
            console.log(response.data);
            setroom(response.data.hall);
    ...
    const handleuserbookings=()=>{
         ...
         props.history.push(`/userhallbooking/?user=${username}&room=${room_id}`);
    ...
    const handlecreatesubmit=(event)=>{
        ...
        axios({
            method :'post',
            url : 'http://localhost:9000/userget/seminarhall/booking',
            headers :{'content-type':'application/json'},
            data: obj
        }).then(response=>{
               ...
               <div class="adminbookpage">
                    <div class="bookpage">
                        <div class="booking-header">
                            <span class="booking-header-block">hall no:{room}</span>
                        </div>
                        <hr></hr>
