...
export default function  Singlesports (props) {
    ...
    const [court_id,setid]=useState(null);
    ...
    axios({
            method :'GET',
            url : 'http://localhost:9000/userget/sports/'+r_id,
    ...
    const handleuserbookings=()=>{
         ...
         props.history.push(`/usersportsbooking/?user=${username}&court=${court_id}`);
    ...
    const handlecreatesubmit=(event)=>{
        ...
        axios({
            method :'post',
            url : 'http://localhost:9000/userget/sports/booking',
            headers :{'content-type':'application/json'},
            data: obj
        }).then(response=>{
               ...
               <div class="adminbookpage">
                    <div class="bookpage">
                        <div class="booking-header">
                            <span class="booking-header-block">court:{court}</span>
                        </div>
                        <hr></hr>
